    ...
    <div className="hero-banner w-full h-[450px] bg-[color:var(--black)] flex items-center relative md:h-[700px]">
      ...
      <ContentWrapper>
        <div className="banner-content flex flex-col items-center text-white text-center relative max-w-[800px] my-0 mx-auto">
          ...
          <span className="subtitle text-[18px] font-medium mb-10 md:text-[40px]">Millions of movies, TV shows and people to discover. Explore now!</span>
          <div className="searchInput flex items-center w-full">
            ...
            <button className='w-[100px] h-[50px] bg-[image:var(--gradient)] outline-0 border-0 rounded-tr-3xl rounded-br-3xl rounded-tl-none rounded-bl-none text-[16px] cursor-pointer md:w-[150px] md:h-[60px] md:text-[18px]'>Search</button>
          </div>
        </div>
      </ContentWrapper>
    </div>
